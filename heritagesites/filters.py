...
class HeritageSiteFilter(django_filters.FilterSet):
	...
	region = django_filters.ModelChoiceFilter(
		field_name='heritagesitejurisdiction__country_area__location__region__region_name',
		label='Region',
	...
	sub_region = django_filters.ModelChoiceFilter(
		field_name='heritagesitejurisdiction__country_area__location__sub_region__sub_region_name',
		label='Subregion',
	...
	intermediate_region = django_filters.ModelChoiceFilter(
		field_name='heritagesitejurisdiction__country_area__location__intermediate_region__intermediate_region_name',
